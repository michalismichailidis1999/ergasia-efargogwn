...
public class Data {
    ...
    private void createData(){
        ...
        foodList.add(new FoodObject("1", "Meat", "Rise", "https://www.healthweb.gr/wp-content/uploads/2020/12/r2.jpg", 169, 31, 4, 0));
        foodList.add(new FoodObject("1", "Meat", "Potatos", "https://5.imimg.com/data5/CL/OX/SB/GLADMIN-2063743/selection-020-500x500.png", 180, 1, 4, 40));
        foodList.add(new FoodObject("1", "Meat", "Steak", "https://www.siakos.gr/340-large_default/strip-loin-steak-moscharisio-ellados.jpg", 169, 31, 4, 0));
    }
